...
def train_iteration(model, optimizer, scheduler, data, nb_batches_per_iter,
  ...
  # model: El TransformerSeq
  # optimizer, scheduler: Para actualizar pesos
  # data: Tensor con TODO el dataset (B x Secuencia_completa)
  # nb_batches_per_iter: Cuántos batches procesar en esta iteración
  # block_size: Tamaño del bloque (M en el paper, ej: 512 tokens)
  # eval_only: True = validación, False = entrenamiento
  # train_pos: Posición actual en la secuencia (dónde vamos)
  # h_cache: Lista de cachés de estados ocultos (uno por capa)
  # batch_split: Para dividir batches grandes
